...
SAVEDIR=/home/v-jiaclin/blob2/v-jiaclin/code/dmp/ckpt/bib_ddi_ckpt_S1/ddi_zoo/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc
...
CUDA_VISIBLE_DEVICES=0 python ddi_zoo/src/train.py $DATADIR \
    ...
    --clip-norm 0.0 \
    --lr-scheduler polynomial_decay --lr 1e-4 --total-num-update 50000 \
