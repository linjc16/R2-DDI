...
ARCH=drug_gcn_large
CLSHEAD=bclsFeatInt
CRITERION=binary_class_loss_cons
DATAFOLD=$1
ALPHA=$2
LR=$3
BATCH_SIZE=$4
...
SAVEDIR=/home/v-jiaclin/blob2/v-jiaclin/code/dmp/ckpt/bib_ddi_ckpt_S1/ddi_zoo/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-alpha$ALPHA-batch_size$BATCH_SIZE-v2
